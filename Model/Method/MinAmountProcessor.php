...
/**
 * Class MinAmountProcessor
 *
 * @package Tklein\PaymentMethodAvailability\Model\Method
 */
final class MinAmountProcessor extends AbstractMethodProcessor
{
    /**
     * {@inheritdoc}
    ...
    {
        $allowedAmount = $this->config->getMinAllowedAmount($methodCode, (string) $quote->getStoreId());
